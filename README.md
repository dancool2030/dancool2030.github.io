...
<span class="cart-count" id="count">
0
</span>
...
<select id="shirtSize" class="size-select">
...
<button
class="btn buy"
onclick="addToCart('Main Shirt - '+document.getElementById('shirtSize').value,30)"
>
...
<!-- keep your image cards here exactly the same -->
